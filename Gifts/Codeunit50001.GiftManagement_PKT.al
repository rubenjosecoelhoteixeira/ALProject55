codeunit 50001 "GiftManagement_PKT"
{
    ...
    var
        GiftCampaign: Record "GIFT Campaign_PKT";
    ...
    local procedure CheckGiftElegibility(var Rec: Record "Sales Line")
    var
        GiftCampaign: Record "GIFT Campaign_PKT";
        Customer: Record Customer;
        SalesHeader: Record "Sales Header";
    ...
    local procedure DoGiftCheck(var SalesLine: Record "Sales Line"; var GiftCampaign: Record "GIFT Campaign_PKT"; var Handled: Boolean)
    var
